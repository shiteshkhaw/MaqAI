...
import { Terminal, Github, Twitter, Linkedin, MapPin } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-10 mb-10">
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="flex items-center gap-2 mb-4 group">
              <Terminal size={24} className="text-brand-accent group-hover:text-white transition-colors" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              ...
              <li><Link to="/security" className="hover:text-brand-accent transition-colors">Privacy Policy</Link></li>
              <li><Link to="/security" className="hover:text-brand-accent transition-colors">Terms of Service</Link></li>
            </ul>
          </div>
        </div>
