      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <Link to="/" className="flex items-center gap-3 group">
            <div className="p-2.5 bg-brand-900 dark:bg-brand-accent rounded-xl text-white shadow-lg shadow-brand-900/20 group-hover:scale-105 transition-all duration-300">
              <Terminal size={22} />
            </div>
