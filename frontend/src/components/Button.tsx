...
export const Button: React.FC<ButtonProps> = ({
    ...
    const variants = {
        ...
        outline: "border border-brand-200 bg-transparent text-brand-900 hover:bg-brand-50 focus:ring-brand-200 dark:border-brand-700 dark:text-white dark:hover:bg-brand-800",
        ghost: "text-brand-700 hover:bg-brand-100 hover:text-brand-900",
        light: "bg-white text-brand-900 hover:bg-gray-100 focus:ring-white shadow-lg"
    };
