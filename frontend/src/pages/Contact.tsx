                    ...
                    <div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-start gap-4 group p-4 rounded-xl hover:bg-white dark:hover:bg-brand-900/30 transition-colors border border-transparent hover:border-gray-100 dark:hover:border-brand-800">
                                ...
                                <div>
                                    <h3 className="font-bold text-brand-900 dark:text-white mb-1 text-base">Core Capabilities</h3>
                                    <span className="text-base text-brand-600 dark:text-brand-200">AI Solutions • Automation • Web Development</span>
                                    <p className="text-gray-400 text-xs mt-1">Trusted by 50+ enterprises across India</p>
                                </div>
                            </div>
                        </div>
                    </div>
